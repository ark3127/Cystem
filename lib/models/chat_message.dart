...
enum MessageRole {
  ...
  assistant,
  tool,
  /// App-injected context (e.g. web-search results) that must never be
  /// confused with something the human actually typed. Never persisted to
  /// storage or shown in the UI — used only for the outgoing API payload.
  system,
}
