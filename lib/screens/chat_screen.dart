...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _editImage(ChatAttachment image) async {
    ...
    try {
      final result = await _generation.editImage(
        source: image,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed:
                _generating ? null : _newConversation,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Ask anything, search the web, share an attachment, or create one.',
              textAlign: TextAlign.center,
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding:
                    const EdgeInsets.fromLTRB(4, 13, 4, 8),
                prefixIcon: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    IconButton(
                    ...
                    IconButton(
                      tooltip: _webSearchMode
                          ? 'Web search on for the next message'
                          : 'Search the web',
  ...
  Widget _attachmentPreview(ChatAttachment attachment) {
    switch (attachment.type) {
      ...
      case ChatAttachmentType.audio:
        return const Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.audiotrack_outlined, size: 30),
            SizedBox(height: 4),
            Text(
              'Audio',
              style: TextStyle(fontSize: 11),
    ...
    switch (attachment.type) {
      ...
      case ChatAttachmentType.video:
        return _genericAttachmentCard(
          ...
          title: attachment.fileName ?? 'Video attachment',
          subtitle: attachment.mimeType ?? 'Video file',
        );
      ...
      case ChatAttachmentType.audio:
        return _genericAttachmentCard(
          ...
          title: attachment.fileName ?? 'Audio attachment',
          subtitle: attachment.mimeType ?? 'Audio file',
        );
      ...
      case ChatAttachmentType.unknown:
        return _genericAttachmentCard(
          ...
          title: attachment.fileName ?? 'File attachment',
          subtitle: attachment.mimeType ?? 'Document',
        );
    }
  }
