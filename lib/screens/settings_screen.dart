      ...
      body: ListView(
        ...
        children: [
          ...
          _SectionHeader(
            ...
            subtitle: 'Gemini is used only for Google Search',
          ),
          _SettingsCard(children: [
            const Text(
              'CYSTEM uses Gemini only for live Google Search. '
              'Image understanding is handled by Nemotron Nano Omni, '
              'normal answers by Nemotron 3 Super 120B, and specialist '
              'answers by Nemotron Ultra 550B.',
              style: TextStyle(
