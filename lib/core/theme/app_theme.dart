...
class AppTheme {
  ...
  static ThemeData darkTheme({Color accent = primary}) =>
      _buildTheme(Brightness.dark, accent);
  static ThemeData lightTheme({Color accent = primary}) =>
  ...
  static ThemeData _buildTheme(Brightness brightness, Color accent) {
    ...
    final softAccent =
        Color.lerp(accent, Colors.white, isDark ? 0.28 : 0.1)!;
    ...
    final scheme = ColorScheme.fromSeed(
      ...
      surfaceContainerHighest:
          isDark ? const Color(0xFF2A2A2F) : const Color(0xFFD9D9DF),
      outline: isDark ? const Color(0xFF36363B) : const Color(0xFFD0D0D6),
      outlineVariant:
          isDark ? const Color(0xFF29292E) : const Color(0xFFE1E1E5),
    ...
    return base.copyWith(
      ...
      dividerTheme: DividerThemeData(
        color: isDark ? const Color(0xFF252529) : const Color(0xFFE4E4E8),
        thickness: 1,
        space: 1,
      ),
      ...
      textTheme: base.textTheme.copyWith(
        ...
        labelMedium:
            TextStyle(color: secondaryText, fontWeight: FontWeight.w500),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        backgroundColor: isDark ? const Color(0xFFF2F2F5) : const Color(0xFF202024),
        contentTextStyle: TextStyle(
          color: isDark ? const Color(0xFF17171A) : Colors.white,
          fontSize: 14,
          fontWeight: FontWeight.w600,
        ),
        actionTextColor: isDark ? accent : primarySoft,
        elevation: 8,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(radiusMedium),
        ),
